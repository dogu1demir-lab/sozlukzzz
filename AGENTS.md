...
- **Profil Fotoğraf Vitrini Mimarisi:** Profil vitrinindeki Slot 1 (#1) her zaman Ana Profil Resmi (`avatarUrl`) için ayrılır. Slot 2, 3, 4 ve 5 ise kullanıcının eklediği vitrin fotoğraflarını (`profilePhotos`) gösterir.
