      ...
      <div className="kd-load-more mt-4 flex justify-center">
        {hasMore ? (
          <button
            ...
            disabled={isLoading}
            className="px-6 py-2.5 rounded-full bg-lime-500 hover:bg-lime-400 text-zinc-950 text-xs font-black transition-all active:scale-95 disabled:opacity-50 shadow-sm"
          >
